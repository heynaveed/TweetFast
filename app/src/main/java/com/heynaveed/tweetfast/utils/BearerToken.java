...
public final class BearerToken {
    ...
    private static final String CONSUMER_KEY = "o2psFcURWRf6y6ymutuweNLMw";
    private static final String CONSUMER_SECRET = "PasA4q4FM7xLDkmsqpJg5qcnxReQd9nozsewoMZuGIaFAPsFLi";
    ...
    private String requestBearerToken() throws IOException{
        ...
        try{
            ...
            bearerCon.setRequestProperty("User-Agent", "TweetFast");
